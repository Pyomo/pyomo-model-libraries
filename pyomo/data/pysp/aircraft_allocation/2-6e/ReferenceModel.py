...
# Variables
#
#NOTE: (Part E) X variables are restricted to be integer
model.X = Var(model.TYPES, model.ROUTES, bounds=(0.0, None), within=Integers)
...
PartEresults = opt.solve(instance)
#PartEresults.write()
print PartEresults.solution.objective
