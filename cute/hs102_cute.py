...
model.c1 = Constraint(expr=1.0-.5*model.x[1]**0.5*model.x[7]/(model.x[3]*model.x[6]**2)-.7*model.x[1]**3*model.x[2]*model.x[6]*model.x[7]**.5/model.x[3]**2\
         -.2*model.x[3]*model.x[6]**(2.0/3)*model.x[7]**.25/(model.x[2]*model.x[4]**.5)>=0)
...
model.c5 = Constraint(expr=10.0*model.x[1]*model.x[4]**2*model.x[7]**a/(model.x[2]*model.x[6]**3)+15*model.x[3]\
         *model.x[4]/(model.x[1]*model.x[2]**2*model.x[5]*model.x[7]**0.5)+20*model.x[2]*model.x[6]/(model.x[1]**2*model.x[4]*model.x[5]**2)\
         +25*model.x[1]**2*model.x[2]**2*model.x[5]**0.5*model.x[7]/(model.x[3]*model.x[6]**2)>=100.0)

model.c6 = Constraint(expr=10*model.x[1]*model.x[4]**2*model.x[7]**a/(model.x[2]*model.x[6]**3)+15*model.x[3]
         *model.x[4]/(model.x[1]*model.x[2]**2*model.x[5]*model.x[7]**0.5)+20*model.x[2]*model.x[6]/(model.x[1]**2*model.x[4]*model.x[5]**2)
         +25*model.x[1]**2*model.x[2]**2*model.x[5]**0.5*model.x[7]/(model.x[3]*model.x[6]**2)<=3000.0)
