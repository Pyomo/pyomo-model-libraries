...
model.constr3 = Constraint(expr = inequality(0, model.x[1], 100))
model.constr4 = Constraint(expr = inequality(0, model.x[2], 100))
model.constr5 = Constraint(expr = inequality(0, model.x[3],  10))
