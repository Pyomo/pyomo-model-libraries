...
model.b1=Constraint(expr= inequality(0.1, model.x[1], 1))
model.b2=Constraint(expr= inequality(0.1, model.x[2], 1))
model.b3=Constraint(expr= inequality(0.1, model.x[3], 1))
model.b4=Constraint(expr= inequality(0.0001, model.x[4], 0.1))
model.b5=Constraint(expr= inequality(0.1, model.x[5], 0.9))
model.b6=Constraint(expr= inequality(0.1, model.x[6], 0.9))
model.b7=Constraint(expr= inequality(0.1, model.x[7], 1000))
model.b8=Constraint(expr= inequality(0.1, model.x[8], 1000))
model.b9=Constraint(expr= inequality(500, model.x[9], 1000))
model.b10=Constraint(expr= inequality(0.1, model.x[10], 500))
model.b11=Constraint(expr= inequality(1, model.x[11], 150))
model.b12=Constraint(expr= inequality(0.0001, model.x[12], 150))
model.b13=Constraint(expr= inequality(0.0001, model.x[13], 150))
