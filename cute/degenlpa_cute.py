...
def f(model):
    return 0.01*model.x[2]+33.333*model.x[3]+100.0*model.x[4]+0.01*model.x[5]+33.343*model.x[6]+100.01*model.x[7]+33.333*model.x[8]+133.33*model.x[9]+100.0*model.x[10]
