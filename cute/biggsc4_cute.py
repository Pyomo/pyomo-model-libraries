...
def con1(model):
    return inequality(0, model.x[1]+model.x[2] -2.5, 5.0)

def con2(model):
    return inequality(0, model.x[1]+model.x[3] -2.5, 5.0)

def con3(model):
    return inequality(0, model.x[1]+model.x[4] -2.5, 5.0)

def con4(model):
    return inequality(0, model.x[2]+model.x[3] -2.0, 5.0)
    
def con5(model):
    return inequality(0, model.x[2]+model.x[4] -2.0, 5.0)
    
def con6(model):
    return inequality(0, model.x[3]+model.x[4] -1.5, 5.0)
